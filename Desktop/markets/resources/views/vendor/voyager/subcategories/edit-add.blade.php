                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- CSRF TOKEN -->
                        ...
                        <!-- Adding / Editing -->
                            ...
                            <ul class="menu">
                                <h3>Ընտրեք ծնող կատեգորիան</h3>
                                <input type="text" name=""  class="menu-cat" disabled>
                                <li class="item1">
                                    <a><span class="ttl">Ծնող կատեգորիա</span><span class="ttl_arrow"><</span></a>
                                    <ul>
                                        @foreach($onecategories  as $item)
                                        <li class="subitem1 category-{{$item->id}}" data-id="{{$item->id}}" data-name="{{$item->name}}">
                                            <a href="/{{config('app.locale')}}/one_category/{{$item->id}}">{{$item->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            var categori_id = $("input[name='category_id']").val();
            if(categori_id>0){
            ...
            $('select').change( function () {
                ...
                $("input[name='category_id']").val(option_val);
            });
