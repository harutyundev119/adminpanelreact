            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12  mb-30">
                        ...
                        <span class="subcats-title"><a href="/{{config('app.locale')}}/{{$category_id->slug}}/{{$subcategory_id->slug}}" class="previous" id="blink7">{{ $subcategory_id->getTranslatedAttribute('name',config('app.locale'),config('voyager.multilingual.default')) }}</a></span>
                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                        <span class="subcats-title">{{ $groupes_id->getTranslatedAttribute('name',config('app.locale'),config('voyager.multilingual.default')) }}</span>
                            ...
                            <div class="product-layout product-grid col-lg-12" id="products-category">
                                @foreach($groupies as $group)
                                    <div class="disp-inl-right col-md-2 col-xs-6">
                                        ...
                                        @endif
                                        @if($groupes_id->slug == $group->slug)
                                            <a  class="btn btn-sub group-active" href="/{{config('app.locale')}}/{{$category_id->slug}}/{{$subcategory_id->slug}}/{{$group->slug}}"><span>{{$group->getTranslatedAttribute('name',config('app.locale'),config('voyager.multilingual.default')) }}</span></a>
                                        @else
